...
env = environ.Env(
    ...
    DEMO_COMPANY_CHART_CACHE_TIMEOUT=(int, 900),
    ACCOUNT_VISIBILITY_CACHE_TIMEOUT=(int, 300),
    REPORT_CACHE_TIMEOUT=(int, 120),
    DEMO_REPORT_CACHE_TIMEOUT=(int, 600),
...
DEMO_COMPANY_CHART_CACHE_TIMEOUT = env("DEMO_COMPANY_CHART_CACHE_TIMEOUT")
ACCOUNT_VISIBILITY_CACHE_TIMEOUT = env("ACCOUNT_VISIBILITY_CACHE_TIMEOUT")
REPORT_CACHE_TIMEOUT = env("REPORT_CACHE_TIMEOUT")
DEMO_REPORT_CACHE_TIMEOUT = env("DEMO_REPORT_CACHE_TIMEOUT")
